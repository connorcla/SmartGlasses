...
void setup() {
  ...
  Paint_DrawString_EN(10, 17, "hello world", &Font8, BLACK, WHITE);
  Paint_DrawNum(10, 30, "123.456789", &Font8, 4, BLACK, WHITE);
  Paint_DrawNum(10, 43, "987654", &Font12, 5, BLACK, WHITE);
  // Show image on page2
  OLED_1IN51_Display(BlackImage);
  Driver_Delay_ms(2000);  
  Paint_Clear(BLACK);   
